...
Claude (Anthropic) was used to assist with Python code structuring, LaTeX formatting, and debugging. All experimental design, analysis, and scientific interpretations are the author's own work.
